									...
									foreach($_POST['no_of_sku'] as $key => $nsku){
										if($key==$av){
											if(empty($_POST['no_of_sku'][$av]) && $tick=='checked'){
											 ...
											 echo "<td><input type=number name=no_of_sku[$av] style=width:50px;border-color:$c; value=$nsku></td>";
										}
									}

								}else{
									echo "<td><input type=number name=no_of_sku[$av] style=width:50px;></td>";
								}
								if(isset($_POST['formsubmit'])){
									foreach($_POST['orc'] as $key => $orc){
										if($key==$av){
											if(empty($_POST['orc'][$av]) && $tick=='checked'){
											 ...
											 echo "<td><input type=number name=orc[$av] style=width:50px;border-color:$c; value=$orc></td>";
										}
									}

								}else{
									echo "<td><input type=number name=orc[$av] style=width:50px;></td>";
								}
								if(isset($_POST['formsubmit'])){
									foreach($_POST['freight'] as $key => $fr){
										if($key==$av){
											if(empty($_POST['freight'][$av]) && $tick=='checked'){
											 ...
											 echo "<td><input type=number name=freight[$av] style=width:50px;border-color:$c; value=$fr></td>";
										}
									}

								}else{
									echo "<td><input type=number name=freight[$av] style=width:50px;></td>";
								}


								if(isset($_POST['formsubmit'])){
									foreach($_POST['ad'] as $key => $fr){
										if($key==$av){
											if(empty($_POST['ad'][$av]) && $tick=='checked'){
											 ...
											 echo "<td><input type=number name=ad[$av] style=width:50px;border-color:$c; value=$ad></td>";
										}
									}

								}else{
									echo "<td><input type=number name=ad[$av] style=width:50px;></td>";
								}
