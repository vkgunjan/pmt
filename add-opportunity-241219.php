...
<?php                                    
 ...
 ?>
             ...
             <select data-placeholder="Select Deal Type" class="span3" tabindex="-1" id="deal_type" name="deal_type" onchange="subType()" required>
 <?php  
...
<?php                                    
 ...
 ?>
             ...
             <select data-placeholder="Select Sub Type" class="span3" tabindex="-1" id="deal_sub_type" name="sub_type" onchange="customer()" required>
 <?php  
...
<?php                                    
 ...
 ?>
             ...
             <select data-placeholder="Select Account Name" class="span5 chosen chzn-done" tabindex="-1" id="account_name" name="ckaname" onchange="account()" required>
 <?php  
...
?>
									<div class="control-group" style="margin-left: 60px;">
                                       <label class="control-label">Account Name<span class="required">*</span></label>
                                       <div class="controls">
                                          <select class="span5 chosen chzn-done"  name="ckaname" id="account_name"  onchange="account()" required>
...
<td>
  ...
  <select  class="chosen-with-diselect span3" id="territory" name="territory" style="width:220px;" required>
...
<?php } ?>
  ...
  <select data-placeholder="Select Channel Partner" class="chosen-with-diselect span4" tabindex="-1" id="partner" name="partner">
                              ...
                              <div class="controls">
               <input class="m-wrap m-ctrl-medium" size="16" type="text" id="dpd1"  name="tile_stage_date" value="<?php echo $dataArray['tile_stage_date']?>" required/>
                              </div>
                           </div>
  ...
  <input type="number"  class="m-wrap medium name=" name="tile_potential_inr" value="<?php echo $dataArray['tile_potential_inr']?>"  required/>
									...
									<div class="control-group" style="margin-left: 60px;">
                                       ...
                                       <div class="controls">
 										<input type="number"  class="m-wrap medium name=" name="obl_sales_forecast_sqmt" value="<?php echo $dataArray['obl_sales_forecast_sqmt']?>"  required/>
                                       </div>
                                    </div>
...
<?php 
		if($_SESSION['employee_department'] == "GET" || $_SESSION['user_type'] == "management"){
