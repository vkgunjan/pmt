						...
						<div class="tabbable tabbable-custom">
							...
							<div class="tab-content">
								...
								<div class="tab-pane row-fluid" id="tab_1_7">
									...
									<div class="row-fluid portfolio-block">
										<div class="span5 portfolio-text" >
											<a href="<?php echo "assets/latest_catalogue/DISC/".$f['cat_img'].".jpg"; ?>" target="_blank"><img id="catPlant" src="<?php echo "assets/latest_catalogue/DISC/".$f['cat_img'].".jpg"; ?>" alt="" style="max-width: 100px; max-height: 100px;"/></a>
											<div class="portfolio-text-info" style="margin-left: 130px;">
												<h4 id="catImg"><?php echo $f['cat_name']; ?></h4>
												<p><?php echo $f['cat_size']; ?></p>
											</div>
