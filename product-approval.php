					...
					<div class="span12">
						...
						<div class="portlet box blue">
							<div class="portlet-title">
								<h4><i class="icon-edit"></i>List of All Lead at Product Approval</h4>
								<div class="tools">
...
//vks ends
			...
			if($_SESSION['employee_department']=='GET' || $_SESSION['employee_department']=='PET' || $_SESSION['employee_department']=='SET' || $_SESSION['employee_department']=='CTU'){
					...
					$sql.=" where d.current_stage='4' 
						...
						$sql.="  where d.current_stage='4' and status='open' and d.created_by='".$_SESSION['uid']."' 
						order by obl_sale_forecast_inr desc ";	
					}
...
//											echo '<td>'.$uf['fullname'].' ('.$uf['employee_department'].')</td>';
									...
									echo '<td width="8%">';
						echo '<a href="product-approval-submit.php?pid='.$f['opportunity_id'].'" class="btn mini blue"><i class="icon-edit"></i>Update</a>';
