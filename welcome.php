<?php
   include_once('including/all-include.php');
	...
	if(isset($_GET['factory_id']) && base64_decode($_GET['factory_id'])>0 )
	$_SESSION['factory_id']=base64_decode($_GET['factory_id']);
?>
<!DOCTYPE html>
<!-- 
			...
			<div class="container-fluid">
				...
				<div class="row-fluid">
					<div class="span12">
						...
						<h3 class="page-title">
						Please Select A  Factory Enter</h3>
						...
						$ss="select * from factory_master";
							...
							while($f=odbc_fetch_array($c)){
								echo '<td align="center">';
									echo '<img src="assets/img/factory.png" style="width:80%;"><br><h3>'.$f['factory_name'].'</h3>';
								echo '</td>';
