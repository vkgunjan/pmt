 ...
 Sales Phase <br />
    <select multiple name="sales_phase[]" style="width:180px; background-color:<?php echo (!empty($_GET['sales_phase']))?'#d6f5d6':'' ?> ">
		<option value="" >-All-</option>
                ...
                <option value="2" <?php echo ($_GET['sales_phase']=='2')?'selected':''?>>First Level Discussion</option>		
	...
	<th>
		...
		<option value="">-All-</option>
        		<option value="BD" <?php echo ($_GET['lead_source']=='BD')?'selected':''?>>BD</option>		
                <option value="CKA" <?php echo ($_GET['lead_source']=='CKA')?'selected':''?>>CKA</option>		
                <option value="GPS" <?php echo ($_GET['lead_source']=='GPS')?'selected':''?>>GPS</option>		
...
//			$sql.=" and a.cka_name like '%God%' ";
			...
			while($rowdata = odbc_fetch_array($rsData)) {
				...
				$sqaureTotal = $rowdata['project_tile_potential_sqm'] + $sqaureTotal;
				$countTotal++;
			}
...
//											echo '<td>'.$uf['fullname'].' ('.$uf['employee_department'].')</td>';
						...
						if(trim($f['status']) == 'open'){
										...
										if(trim($f['current_stage'])=='Opportunity'){
											$cstage='Opportunity';
											echo '<th>'.$cstage.'</th>';
			echo '<td >';
				...
				echo '<a href="lead-history.php?pid='.$f['opportunity_id'].'" class="btn mini yellow no-print"><font color="#000">Detail&nbsp;</font></a>';
										...
										if(trim($f['current_stage'])=='First Discussion'){
			...
			echo '<a href="add-opportunity.php?pid='.$f['opportunity_id'].'" class="btn mini blue no-print"><i class="icon-edit"></i>Edit</a>';
				...
				echo '<a href="lead-history.php?pid='.$f['opportunity_id'].'" class="btn mini yellow no-print"><font color="#000">Detail&nbsp;</font></a>';
										...
										if(trim($f['current_stage'])=='Sampling'){
											$cstage='Sampling';
											echo '<th>'.$cstage.'</th>';
			echo '<td >';
			echo '<a href="add-opportunity.php?pid='.$f['opportunity_id'].'" class="btn mini blue no-print"><i class="icon-edit"></i>Edit</a>';
				...
				echo '<a href="lead-history.php?pid='.$f['opportunity_id'].'" class="btn mini yellow no-print"><font color="#000">Detail&nbsp;</font></a>';
										...
										if(trim($f['current_stage'])=='Product Approval'){
			...
			echo '<a href="add-opportunity.php?pid='.$f['opportunity_id'].'" class="btn mini blue no-print"><i class="icon-edit"></i>Edit</a>';
				...
				echo '<a href="lead-history.php?pid='.$f['opportunity_id'].'" class="btn mini yellow no-print"><font color="#000">Detail&nbsp;</font></a>';
										...
										if(trim($f['current_stage'])=='Quotation'){
											$cstage='Quotation';
											echo '<th>'.$cstage.'</th>';
			echo '<td >';
			echo '<a href="add-opportunity.php?pid='.$f['opportunity_id'].'" class="btn mini blue no-print"><i class="icon-edit"></i>Edit</a>';
				...
				echo '<a href="lead-history.php?pid='.$f['opportunity_id'].'" class="btn mini yellow no-print"><font color="#000">Detail&nbsp;</font></a>';
										...
										if(trim($f['current_stage'])=='Negotiation'){
											$cstage='Negotiation';
											echo '<th>'.$cstage.'</th>';
			echo '<td >';
