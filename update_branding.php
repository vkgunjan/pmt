                        ...
                        <div class="tab-pane active" id="tab_1">
                           <div class="portlet box purple">
                              <div class="portlet-title">
                                 <h4><i class="icon-globe"></i>Update Branding Request</h4>
                                 <div class="tools">
                              ...
                              <div class="portlet-body form">
                                 ...
                                 <!-- BEGIN FORM-->
                                    ...
                                    <div class="form-actions">
                                       ...
                                       <a href="branding_request.php"><button type="button" class="btn"><i class="m-icon-swapleft"></i> &nbsp;Cancel</button></a>
                                       ...
                                       <button type="submit" id="btn" name="branding" class="btn green"><i class="icon-ok"></i> Approve</button>
                                       <button type="submit" id="btn" name="branding" class="btn red"><i class="icon-remove"></i> Reject</button>
                                    </div>
