...
print '
 <table class="table  table-bordered" width="90%">
									<thead>
										...
										<tr>
										<th colspan="12" align="center" bgcolor="#F7060D"><font size="4" color=white><center>List of Breakdown Maintenance Request</center></font></th>
										</tr>
 ...
 $sss="SELECT a. [asset_id]
	 ...
	 a.asset_kept_area
	  ...
	  ,b.[request_id]
	   ...
	   left join department_section_master dsm on a.department_section = dsm.department_section_id
	   left join location_master lm on a.asset_location = lm.location_master_id
	   where b.factory_id=".$_SESSION['factory-id']." and request_status_for_wo is null
	   order by b.request_id desc  ";
									...
									while($ff = odbc_fetch_array($rrs)){
										...
										echo '<td colspan="8">'.$ff['request_description'].'</td>';
										echo '<td><a href="breakdown-asset-wo-selection.php?id='.$ff['asset_id'].'&request_id='.$ff['request_id'].'"><input type="button" value="Make WO"></a></td>';
										echo '</tr>';
