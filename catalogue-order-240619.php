         ...
         if(isset($_POST['formsubmit'])){
          ...
          foreach ($ex_cat as $cat) {
            ...
            $cat_sql = "INSERT INTO log_history (lg_city,lg_code, lg_uid, lg_emp_code, lg_full_name, lg_emp_email, lg_mobile, lg_catalogue_id, lg_required_date, lg_address, lg_remarks, lg_created_date, lg_updated_date, lg_status) values 
              ('$city','$unique_msg_id','$av','$emp_code','$fullname','$emp_email','$contact','$cat_new','$required_date','$address','$remarks',getdate(),getdate(),'1')";
          ...
          if ($result && $cat_result) {
            ...
            $subject = "OBL-MKT || Catalogue Order Request";
                  ...
                  <p>This is an auto generated Email, Please do not reply. Catalogue order has been requested by <b>$fullname</b> for dispatch. Kindly refer to below details for more clarification.
                  </p>
