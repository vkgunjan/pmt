...
//print_r($errorArray);
	...
	if(empty($errorArray)){
		...
		$stmt = odbc_prepare($conn, $upd);
				...
				header('Location:asset-master.php?msgType=' . $msgType . '&msgTxt=' . base64_encode($msgTxt));
				exit;
...
if(isset($_SESSION['working-acive-asset'])){
		
		$formType = 'Update Asset Master Details ';
		
		$btsel="select * from asset_master where asset_code='".dbInput($_SESSION['working-acive-asset'])."'";
		$rs=odbc_exec($conn,$btsel);
		$f = odbc_fetch_array($rs);
		//print_r($f);

		$dataArray=array(
					'asset_code'						=>	trim(dbOutput($_SESSION['working-acive-asset'])),
	...
	if($_POST['warranty_end_dd']=='Date' || $_POST['warranty_end_mm']=='Month' || $_POST['warranty_end_yy']=='Year' ){
		...
		print_r($dataArray);
		 ...
		 warranty_end='".dbInput($dataArray['warranty_end'])."'
		  ";
		 $upd .=" where asset_code='".dbInput($_SESSION['working-acive-asset'])."'";
...
<?php /*?>                                <li class="<?php echo (isset($_GET['tab2'])?'active':'')?>"><a href="#portlet_tab2" data-toggle="tab">Purchase Details</a></li>
...
<?php */?>
                      ...
                      <!-- tab 1 asset details start --> 
                              ...
                              <div class="tab-pane active" id="portlet_tab1">
                                 ...
                                 <form action="<?php echo $_SERVER['PHP_SELF']?>" method="post" class="form-horizontal">
                                    ...
                                    <div class="control-group">
                                       ...
                                       <div class="controls">
                                          <select class="medium m-wrap" tabindex="1" name="asset_type"  required>
                                             <?php
                                    ...
                                    <div class="control-group">
                                       ...
                                       <div class="controls">
                                          <select class="medium m-wrap" tabindex="1" name="plant_building" required>
                                             <?php
                                    ...
                                    <div class="control-group">
                                       ...
                                       <div class="controls">
                                          <select class="medium m-wrap" tabindex="1" name="department_section" required>
                                             <?php
                                    ...
                                    <div class="control-group">
                                       ...
                                       <div class="controls">
                                          <select class="medium m-wrap" tabindex="1" name="asset_location" required>
                                             <?php
                                    ...
                                    <div class="control-group">
                                     ...
                                     <div class="control-group">
                                       ...
                                       <div class="controls">
                                          ...
                                          value="<?php echo $dataArray['aggreement_number']?>" required/>
                          ...
                          <!-- tab 3, maintenance detail-->  
 							 ...
 							 <div class="portlet-body">
								<div class="clearfix">
                                	<div class="btn-group">
										...
										Add Maintenance <i class="icon-plus"></i>
										</button>
                                  ...
                                  <table class="table table-striped table-hover table-bordered" >
									<thead>
										<tr>
											...
											<th>Start Date</th>
											<th>Recurence Type</th>
											<th>Recurence Details</th>                                            
                                            <th>Action</th>                                            
									...
									<tbody>
										<tr class="">
											...
											<td>10-05-2015</td>
											<td>Monthly</td>
											<td>2nd Sat of Every Month</td>
                                            <td>
                                            	<a href="asset-master.php" class="btn mini blue"><i class="icon-edit"></i> Edit</a>
	                                            <a href="#" class="btn mini red"><i class="icon-trash"></i> Delete</a>
                                            </td>
                                         </tr>
									</tbody>
								</table>
                           ...
                           <div class="tab-content">
                              <div class="tab-pane active" id="portlet_tab1">
                                <form action="#" class="form-horizontal" id="scm">
                             ...
                             <div class="control-group" style="float:left">
									...
									$rs=odbc_exec($conn,$sql);
										while($f = odbc_fetch_array($rs)){
										echo '<option>'.$f['maintenance_type'].'</option>';
										}
									?>
                                          </select>
                                       </div>
                                 ...
                                 <div class="control-group" id="week">
                                    ...
                                    <label class="control-label"><br>Date</label>
                                       <div class="controls">
                                          <select class="large m-wrap" tabindex="1">
