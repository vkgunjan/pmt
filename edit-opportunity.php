...
//print_r($errorArray);
	...
	if(empty($errorArray)){
		...
		$_SESSION['working-active-asset']=$dataArray['asset_code'];
				...
				$val = "SELECT o.lead_id,d.deal_type, s.deal_sub_type, a.cka_name, o.project_name, t.state_name, o.tile_stage_date, o.project_tile_potential_inr, o.project_tile_potential_sqm, o.project_contact_name, o.address, o.opp_remark, o.file_path from 
							opportunity o
...
<td>
                        ...
                        <input type="text"  class="m-wrap large" name="gps_department_name" value="<?php echo $dataArray['gps_department_name']?>"  />
                                       ...
                                       <div class="controls">
                        <input type="text"  class="m-wrap large" name="project_name" required value="<?php echo $dataArray['project_name']?>" required disabled/>
                        		...
                        		<div class="control-group" style="margin-left: 60px;">
                                       ...
                                       <div class="controls">
                                          <select class="chosen span3"  name="state" required>
                                          <option value="">-Select-</option>
                                            <?php
  ...
  <select data-placeholder="Select Territory" class="chosen span6" tabindex="-1" id="territory" name="territory" style="width:220px;" required>
                    ...
                    <input type="text"  class="m-wrap large" name="address" value="<?php echo $dataArray['address']?>" required />
									...
									<div class="control-group" style="margin-left: 60px;">
                                       ...
                                       <div class="controls">
                                          <select class="chosen span3"  name="architect_name">
                                          <option value="">-Select-</option>
                                            <?php
  ...
  <select data-placeholder="Select Channel Partner" class="chosen span4" tabindex="-1" id="partner" name="partner">
