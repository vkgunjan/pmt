...
?>
          ...
          ?>
                                  ...
                                  <input type="hidden" name="pid" id="pid" value="<?php echo $pid?>"> 
                                    ...
                                    <div class="row-fluid">
                                      ...
                                      <div class="control-group">
                                         ...
                                         <input type="file" name="newFile" id="u_fileExtension" class="default">
                    ...
                    <?php }else{ ?>
                            ...
                            <form action="<?php echo $_SERVER['PHP_SELF']?>" method="post" class="form-horizontal" id="addData" enctype="multipart/form-data">
                                  <!-- <input type="hidden" name="pid" value="<?php echo $pid?>">  -->
                                    ...
                                    <div class="row-fluid">
                                      ...
                                      <div class="control-group">
                                         <label class="control-label">PDF Document:</label>
                                         <div class="controls">
                                         <input type="file" name="file" id="fileExtension" class="default" required>
                                         </div>
                                      </div>
                                       </div>
                                    </div>
   ...
   ?>
    ...
    $(document).ready(function(){
     ...
     $("#update").click(function(e){
          ...
          var filename = $("#u_fileExtension").val();
          /*alert(filename);*/

        // Use a regular expression to trim everything before final dot
        var extension = filename.replace(/^.*\./, '');
        var u_get_category = $('select#u_get_category').children("option:selected").val();
        var u_get_sub_category = $('select#u_get_sub_category').children("option:selected").val();
        var u_get_dept = $('select#u_get_dept').children("option:selected").val();
        var u_get_city = $('select#u_get_city').children("option:selected").val();
        var u_get_cat = $('select#u_get_cat').children("option:selected").val();
        var u_get_doc_name = $('#u_get_doc_name').val();
        var u_get_doc_desc = $('#u_get_doc_desc').val();
        var creation_remark = $('#creation_remark').val();
        var pid = $('#pid').val();

        /*alert(u_get_sub_category);
        exit();*/
        ...
        if(extension != 'pdf' ){
          ...
          return false;
            ...
            $.ajax({
                 url: "update_doc.php",
                 type: "POST",
                 data:  {u_get_category:u_get_category,u_get_sub_category:u_get_sub_category,u_get_dept:u_get_dept,u_get_city:u_get_city,u_get_cat:u_get_cat,u_get_doc_name:u_get_doc_name,u_get_doc_desc:u_get_doc_desc,u_creation_remark:u_creation_remark,pid:pid,filename:filename},
                 contentType: false,
                 cache: false,
           ...
           success: function(data)
            ...
            {
             // invalid file format.
             $("#err_msg").html("Invalid File !").fadeIn();
             /*alert("Invalid File Document");
             return false;*/
            }
            else
            {
             ...
             /*$("#addData")[0].reset();*/
             window.location.replace("list-doc.php"); 
            }
              },
             error: function(e) 
              {
            $("#err_msg").html(e).fadeIn();
              }          
            });
...
<script type="text/javascript">
  $(document).ready(function(e){
    $("#addData").on('submit',(function(e) {
          ...
          var filename = $("#fileExtension").val();
        ...
        if(extension != 'pdf' ){
          ...
          return false;
           ...
           success: function(data)
            ...
            {
             // invalid file format.
             $("#error_msg").html("Invalid File !").fadeIn();
             /*alert("Invalid File Document");
             return false;*/
            }
            else
