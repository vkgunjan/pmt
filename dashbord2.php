...
<?php
			if(trim($_SESSION['user_type'])=='management') {
$ttv="select top 10 o.opportunity_id, c.cka_name, o.project_name, s.state_name, o.city, o.project_name, o.current_stage, o.created_by, o.project_tile_potential_inr,
