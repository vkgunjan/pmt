...
<div class="portlet box blue" style="padding-left:120px;">
							<div class="portlet-title">
								<h4><i class="icon-reorder"></i>CKA Sales Target Vs Achievement in (%)</h4>
								<div class="tools">
...
?>
<input class="knobify" data-width="115" data-fgcolor="#4b8df8" data-thickness=".2" data-skin="tron" data-displayprevious="true" value="<?php echo $cmp?>"  data-max="190" data-min="-100" title="<?php echo $cmp?>% of Sales Achievement"/>
											</div>
											<div class="details">
...
?>
											...
											<div class="details">
					<div class="title">Month to Date <i class="<?php echo($mtdap<80)?'icon-caret-down down' :'icon-caret-up' ?>"></i></div>
...
mar=(select sum(mar) from sales_target)";
 ...
 ?>  
									...
									<div class="span3 responsive" data-tablet="span6" data-desktop="span3">
										<div class="circle-stat block">
											<div class="visual">
												<input class="knobify" data-width="115" data-fgcolor="#339966" data-thickness=".2" data-skin="tron" data-displayprevious="true" value="<?php echo $aap?>" data-max="270" data-min="-100" title="<?php echo $mtdap?>% of Annual Sales Achievement"/>
											</div>
					<div class="details">
...
<?php
	$stage=array('Opportunity', 'First Discussion', 'Sampling', 'Product Approval', 'Quotation', 'Negotiation', 'Closure');
...
<?php
			if(trim($_SESSION['user_type'])=='management') {
$ttv="SELECT top 10 c.cka_name,o.project_name, s.state_name,o.city, o.project_name, o.current_stage, o.project_tile_potential_inr, o.obl_sale_forecast_inr  FROM opportunity o, cka_name_master c, state_master s
where o.[status]='open' 
