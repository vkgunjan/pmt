...
if(isset($_POST['submit'])){
	 ...
	 $sql="
select gs.schedule_generated_date, gs.reschedule, s.asset_id, gs.schedule_generated_id, s.recurrence_schedule, s.maintenance_type_id, m.maintenance_type , a.asset_code, a.asset_name, at.asset_type, a.asset_kept_area, p.plant_building_name from schedule_generated gs
...
font-size:11px;  
						...
						<div class="portlet box blue">
                         ...
                         <div style="width:100%;" >   
							...
							if(trim($_SESSION['user_type'])=='engineer')
                            	...
                            	&nbsp;&nbsp;&nbsp;	 
                         <b>  Asset Type	</b><select name="asset_type" style="width:150px;">
                                       		<option value="all">All</option>
                                             <?php
							if(trim($_SESSION['user_type'])=='engineer')
								...
								$ssql="select * from asset_type_master where factory_id='".$_SESSION['factory-id']."' order by asset_type asc";	
									...
									?>
                                      	...
                                      	&nbsp;&nbsp;&nbsp;    
                                        <b>  Plant Building </b><select name="plant_building" style="width:100px;">
                                       		<option value="all">All</option>
                                             <?php
							if(trim($_SESSION['user_type'])=='engineer')
 ...
 <button type="submit" name="submit" value="true" class="btn green" style="margin-top:-10px;" onClick="return submitcheck();">Refresh&nbsp; 
                      ...
                      <form action="exp.php" method="post" onsubmit='$("#datatodisplay").val( $("<div>").append( $("#ReportTable").eq(0).clone() ).html() )'>  
					  
					  <input type="hidden" id="datatodisplay" name="datatodisplay">  
						<div style="text-align:right;">
						<input type="submit" value="Export to Excel">  
						</div>
                        <table class="table table-striped table-hover table-bordered" id="ReportTable" class="myClass" >
									<thead>
										<tr>
											<th>#</th>
											<th>Schedule Date</th>
