...
$ftch=odbc_fetch_array($reg_sqlexe);
		...
		echo '<tr align="right">';
					...
					echo '<td>&#8377 '.valchar2($ftch['ncsum']).'</td>';
							$sum=$sum+$ftch['ncsum'];
					...
					echo '<td>&#8377 '.valchar2($ftch['east']).'</td>';
							$sum=$sum+$ftch['east'];
					...
					echo '<td>&#8377 '.valchar2($ftch['west']).'</td>';
							$sum=$sum+$ftch['west'];
					...
					echo '<td>&#8377 '.valchar2($ftch['south']).'</td>';
							$sum=$sum+$ftch['south'];
