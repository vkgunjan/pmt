...
//   print_r($_POST);
      /*if(isset($_POST['submit'])){
        ...
        /* $dataArray=array(
         ...
         $fchk=0;
         foreach ($_POST['catalogue_name'] as $sd ) {
          $_POST['city'][$sd];
          $_POST['state'][$sd];
          $_POST['territory'][$sd];
          $_POST['emp_code'][$sd];
               ...
               <div class="span12">
                  <div class="portlet box light-grey" id="form_wizard_1">
                     ...
                     <div class="portlet-body form">
                        <form action="<?php echo $_SERVER["PHP_SELF"]; ?>" method="POST" class="form-horizontal" onsubmit="return submitform()" name="myform">
                                 ...
                                 <div class="tab-pane" id="tab2">
                                    ...
                                    <div class="control-group">
                                       ...
                                       <div class="controls">
                                          <div class="input-icon left">
                                             ...
                                             <input class="span2 m-wrap " type="text" placeholder="Emp Code" id="emp_code" name="emp_code" required="required" value="<?php echo $emp_code; ?>"> 
                                          </div>
                                       </div>
                                    </div>
                                    <div class="control-group">
                                       ...
                                       <div class="controls">
                                          <div class="input-icon left">
                                             <i class="icon-user"></i>
                                             <input class="span3 m-wrap " type="text" placeholder="Full Name" name="full_name" id="full_name" value="<?php echo $fullname; ?>"> 
                                          </div>
                                       </div>
                                    </div>
                                    <div class="control-group">
                                       ...
                                       <div class="controls">
                                          <div class="input-icon left">
                                             ...
                                             <input class="span4 m-wrap " type="text" name="email" id="email" placeholder="Email Address" value="<?php echo $emp_email; ?>"> 
                                          </div>
                                       </div>
                                    </div>
                                    <div class="control-group">
                                       ...
                                       <div class="controls">
                                          <div class="input-icon left">
                                             ...
                                             <input class="span3 m-wrap " type="number" placeholder="Phone Number" name="contact" id="contact" value="<?php echo $contact; ?>"> 
                                          </div>
                                       </div>
                                    </div>
                                    <div class="control-group">
                                    ...
                                    <div class="controls">
                                       <div class="input-append date date-picker" data-date="12-02-2012" data-date-format="dd-mm-yyyy" data-date-viewmode="years">
                                          <input class="m-wrap m-ctrl-medium date-picker" size="16" type="text" value="" name="required_date" id="required_date"><span class="add-on"><i class="icon-calendar" ></i></span>
                                    </div>
                              </div>
                           </div>
                                    <div class="control-group">
            ...
            ?>
                  ...
                  <!-- </div> -->
                              ...
                              <div class="form-actions clearfix">
                                 ...
                                 <button type="submit" name="formsubmit" class="btn green button-submit">
