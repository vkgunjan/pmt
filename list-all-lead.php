...
$top = '';
		...
		(select top 1 fld_id from fld where opp_id = o.opportunity_id) as fld_id
...
/*Adding action status end*/
										...
										/*echo '<div class="hover_new"><a href="lead-history.php?pid='.$f['opportunity_id'].'" class="btn mini green no-print">Transfer Lead</a></div>';*/
										echo '</td>';	
