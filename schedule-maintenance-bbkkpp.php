...
//print_r($dataArray);
	...
	if(empty($errorArray)){
				...
				$bt="select schedule_id from schedule where asset_id='".dbInput($dataArray['asset_id'])."' 
				 and maintenance_type_id='".dbInput($dataArray['maintenance_type_id'])."' ";
		...
		$insert  ="INSERT INTO schedule (asset_id, maintenance_type_id, activation_date, recurrence_schedule, day, frequency, month, factory_id)";
				...
				'".dbInput($dataArray['month'])."', '".dbInput($_SESSION['factory-id'])."' ) ";
 ...
 left join maintenance_type_master m on m.maintenance_type_id=s.maintenance_type_id 
	 ...
	 ";
									...
									while($f = odbc_fetch_array($rs)){
										...
										echo '<td><a href="#" class="btn mini red"><i class="icon-trash"></i> Delete</a></td>';
									}
									?>
...
<td style="width:60%">
                                       ...
                                       <div class="controls">
                                          <select class="medium m-wrap"  name="maintenance_type_id" required id="m_type">
...
<td align="left"  valign="top" style="border-left:groove; width:40%">
	...
	<table style="width:100%;" id="show_checklist">
		<tr>
