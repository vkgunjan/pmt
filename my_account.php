...
$sql="SELECT  
                ...
                if(trim($_SESSION['user_type'])=='management') {
                $sql.="  and a.deal_type != 'Retail' group by c.cka_name_id,a.deal_type, b.deal_sub_type, c.cka_name,c.city, c.engaged, e.engagement, s.eng_sub_name, c.cka_category, u.fullname, c.updated_on order by c.updated_on desc ";
                }else{
                        ...
                        if($_SESSION['employee_department']=='GET' || $_SESSION['employee_department']=='PET' || $_SESSION['employee_department']=='SET' || $_SESSION['employee_department']=='CTU' || $_SESSION['employee_department']=='Retail'){
                          ...
                          $sql.=" and 
                            ...
                            $sql.="  and o.created_by='".$_SESSION['uid']."' and a.deal_type != 'Retail' 
                            group by c.cka_name_id,a.deal_type, b.deal_sub_type, c.cka_name,c.city, c.engaged, e.engagement, s.eng_sub_name, c.cka_category, u.fullname, c.updated_on order by c.updated_on desc";  
                          }
                  ...
                  <div class="portlet box green tabbable">
                     ...
                     <div class="portlet-body form">
                      ...
                      c.cka_status
										...
										$rs_deal=odbc_exec($conn,$sql_deal);
										while($f = odbc_fetch_array($rs_deal)){
                                       ...
                                       <div class="span6 ">
                                          <div class="control-group">
                                             ...
                                             <div class="controls">
                                                ...
                                                <select class="medium m-wrap" name="c_city" id="c_city">
                                    ...
                                    <div class="row-fluid">
                                       <div class="span6 ">
                                          <div class="control-group">
                                             ...
                                             <div class="controls">
                                                <select class="medium m-wrap" name="eng_status_modal" id="eng_status_modal">
                                                <option value="">-Status-</option>
                                                <?php
                                                                    $eng_sql="SELECT * from engagement_status where status = 1";
                                                                    $eng_rs=odbc_exec($conn,$eng_sql);
                                                                    while($e = odbc_fetch_array($eng_rs)){
                                                                    /*$selected=($f['cka_name_id']== $('select#cka_name_id').children("option:selected").val())?'selected':'';*/
                                       ...
                                       <div class="span6 ">
                                          <div class="control-group">
                                             ...
                                             <div class="controls">
                                                <select class="medium m-wrap" name="sub_status_modal" id="sub_status_modal">
...
<!-- </form> -->
                    ...
                    <button class="btn dropdown-toggle" data-toggle="dropdown">Export <i class="icon-angle-down"></i>
                    </button>
                    <ul class="dropdown-menu">
                      <li><a href="export_account.php?val_proj=<?php echo base64_encode($sql); ?>">Export</a></li>
                      <li><a href="export_engagement.php?val_arch=<?php echo base64_encode($m); ?>">Architect Report</a></li>
                    </ul>
                  </div>
               ...
               success:function(data){
                ...
                /*var engaged = $('input:radio[name=engaged]:checked').val();*/
                 ...
                 $("#sub_status").append("<option>- Sub Status -</option>");
                  ...
                  /*$("#eng_status option[value=3]").attr('selected', 'selected');*/
                 $("#eng_status").empty();
                 $("#sub_status").empty();
