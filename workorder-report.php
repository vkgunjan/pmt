						...
						<div class="portlet box red">
                         ...
                         <div style="width:100%;" >   
                         	...
                         	<select name="maintenance_type" style="width:240px;">
									...
									&nbsp;&nbsp;&nbsp;
                                    <b>Engineer</b>
                         	<select name="engineer" style="width:150px;">
                                       		<option value="">All</option>
                                             <?php
                            	 ...
                            	 &nbsp;&nbsp;
                                   <b>WO Type</b>
                                  <select name="wo_type" style="width:100px;">
                                       		<option value="">All</option>
                                 ...
                                 &nbsp;&nbsp;
                                   <b>Status</b>
                                  <select name="wo_status" style="width:140px;" >
                            	 ...
                            	 &nbsp;&nbsp;
                                   ...
                                   &nbsp;&nbsp;
                                   <b>Asset Type</b>
									<select name="asset_type" style="width:150px;">
                                       		<option value="">All</option>
                                             <?php
