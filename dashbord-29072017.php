                    ...
                    <div class="span3 responsive" data-tablet="span6" data-desktop="span3">
						...
						<div class="span3 responsive" data-tablet="span6" data-desktop="span3">
							<div class="dashboard-stat" style="background-color:#666;">
								...
								<?php echo (empty($negotiationno))?'0':$negotiationno?> DEALS  <i class="m-icon-swapright m-icon-white"></i>
                                </a>						
							</div>
						</div>
						<div class="span3 responsive" data-tablet="span6  fix-offset" data-desktop="span3">
...
<?php
			$totq="SELECT COUNT(*) as tlead, sum(project_tile_potential_inr) as tval FROM opportunity where [status]='open' ";
...
<?php
			$bq="SELECT  COUNT(*) as totalb,  sum(project_tile_potential_inr) as project  FROM opportunity where [cka_type_id]='1' and [status]='open'  ";
...
<?php
			$bq="SELECT  COUNT(*) as totalb,  sum(project_tile_potential_inr) as project  FROM opportunity where [cka_type_id]='2' and [status]='open'  ";
			$bqe=odbc_exec($conn,$bq);
			$bf=odbc_fetch_array($bqe);
			//print_r($bf);
			//echo 'total lead - '.$tot['tlead'];
...
<?php
			$bq="SELECT  COUNT(*) as totalb,  sum(project_tile_potential_inr) as project  FROM opportunity where [cka_type_id]='3' and [status]='open'  ";
			$bqe=odbc_exec($conn,$bq);
			$bf=odbc_fetch_array($bqe);
			//print_r($bf);
			//echo 'total lead - '.$tot['tlead'];
						...
						<div class="portlet box green">
							...
							<div class="portlet-body">
								<table class="table table-striped table-bordered table-advance table-hover">
                                    ...
                                    <tbody>
<?php
$ttv="SELECT top 10 c.cka_name, s.state_name,o.city, o.project_name,o.project_tile_potential_inr  FROM opportunity o, cka_name_master c, state_master s
where o.[status]='open' 
					...
					<div class="span6">
						...
						<div class="portlet box red">
							...
							<div class="portlet-body">
                                    ...
                                    <tbody>
<?php
$ttv="SELECT top 10 c.cka_name, s.state_name,o.current_stage, o.project_tile_potential_inr  FROM opportunity o, cka_name_master c, state_master s
where o.[status]='lost' 
and c.cka_name_id = o.cka_name_id and s.state_id= o.state_id
order by o.project_tile_potential_inr desc";
