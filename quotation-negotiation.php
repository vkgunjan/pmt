					...
					<div class="span12">
						...
						<div class="portlet box blue">
							<div class="portlet-title">
								<h4><i class="icon-edit"></i>List of All Lead at Quotation Level</h4>
								<div class="tools">
...
//											echo '<td>'.$uf['fullname'].' ('.$uf['employee_department'].')</td>';
										...
										if(trim($f['current_stage'])=='2'){
											$cstage='Discussion';
											$hyperlink='quotation-negotiation-submit';
										}
									...
									if ($quotation_status == 0) {
												echo '<td width="8%">';
				echo '<a href="quotation-negotiation-submit.php?pid='.$f['opportunity_id'].'" class="btn mini blue"><i class="icon-edit"></i>Update</a>';
			...
			echo '</td>';
												...
												echo '<td width="7%">';
				echo '<a href="quotation-negotiation-submit.php?pid='.$f['opportunity_id'].'" class="btn mini blue">Approved</a>';
				echo '<a href="lead-history.php?pid='.$f['opportunity_id'].'" class="btn mini yellow no-print"><font color="#000">Detail&nbsp;</font></a>';
			...
			echo '</td>';
												...
												echo '<td width="8%">';
				echo '<a href="quotation-negotiation-submit.php?pid='.$f['opportunity_id'].'" class="btn mini red">Pending</a>';
				echo '<a href="lead-history.php?pid='.$f['opportunity_id'].'" class="btn mini yellow no-print"><font color="#000">Detail&nbsp;</font></a>';
