         ...
         if(isset($_POST['formsubmit'])){
          ...
          foreach ($ex_cat as $cat) {
            ...
            $cat_sql = "INSERT INTO log_history (lg_city,lg_code, lg_uid, lg_emp_code, lg_full_name, lg_emp_email, lg_mobile, lg_catalogue_id, lg_required_date, lg_address, lg_remarks, lg_created_date, lg_updated_date, lg_status) values 
              ('$city','$unique_msg_id','$av','$emp_code','$fullname','$emp_email','$contact','$cat_new',getdate(),'$add','$remarks',getdate(),getdate(),'1')";
          ...
          if ($result && $cat_result) {
            ...
            $subject = "OBL-MKT || Catalogue Order Details";
                        $to = $m_email;
                        $body = '<html>
                             <head>
                             <title></title>
          ...
          <br><br>
                  ...
                  <p><b>Order Remarks:</b>&nbsp; $m_remarks</p><br>
                  <div>
                  <b>Note:-</b> Actual Quantity will be displayed after dispatching the order.
                  </div>
                  <br><br><br>
                  <div>
                  Regards,<br>
   ...
   <div class="row-fluid">
               <div class="span12">
                                    ...
                                    <div class="control-group">
                                       ...
                                       <div class="controls">
                                          <div class="input-icon left" id="address1">
                                             <i class="icon-edit"></i>
                                             <input class="span6 m-wrap " type="text" name="address1" id="add1" placeholder="Complete Address with PIN No for Dispatch.." value="<?php echo $u_address; ?>" disabled> 
                                          </div>
                                          <div class="input-icon left" id="address2">
                                             <i class="icon-edit"></i>
                                             <input class="span6 m-wrap " type="text" name="address2" id="add2" placeholder="Complete Address with PIN No for Dispatch.."> 
                                          </div>
                                       </div>
                                    </div>
                  ...
                  <!-- <div class="control-group"> -->
                     ...
                     $sql = "SELECT * from cat_master where cat_status = 1 order by cat_order asc";
...
$(document).ready(function(){
  ...
  <script>
    $(document).ready(function(){
      ...
      $('#add').text($('#add1').val());
      var isChecked1 = $('#other').prop('checked');
      $('#add2').keyup(function() {
      $('#add').text($(this).val());
      });
