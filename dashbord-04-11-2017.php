...
<div class="portlet box blue" style="padding-left:120px;">
							<div class="portlet-title">
								<h4><i class="icon-bell"></i>Tiling Stage for Comming Months </font></h4>
								<div class="tools">
									<a href="javascript:;" class="collapse"></a>
									<a href="javascript:;" class="reload"></a>
									<a href="javascript:;" class="remove"></a>
...
*/
	...
	$totalvalue=0;
			echo '<tr align="center">';
					echo  '<td align="left">'.$stage[$x-1].'</td>';
					echo '<td>'.valchar($fftch['m1']).'</td>';
					echo '<td>'.($fftch['m1c']).'</td>';

					echo '<td>'.valchar($fftch['m2']).'</td>';
					echo '<td>'.($fftch['m2c']).'</td>';

					echo '<td>'.valchar($fftch['m3']).'</td>';
					echo '<td>'.($fftch['m3c']).'</td>';
...
$dfq="select opportunity_id from dashboard_view_tbl where view_data_visible_to='".$_SESSION['uid']."' ";
    ...
    m3 = (
	  ...
	  "; 
       ...
       ?>	
										...
										<tr align="center">
                                            <td bgcolor="#99FFFF"><?php echo $mth1 ?></td>

                                            <td bgcolor="#99FFFF"><?php echo $mth2 ?></td>

                                            <td bgcolor="#99FFFF"><?php echo $mth3 ?></td>
                                        </tr>
...
<?php
			if(trim($_SESSION['user_type'])=='management') {
$ttv="SELECT top 10 o.cka_name,o.project_name, o.state_name,o.city, o.project_name, o.current_stage, created_by, o.project_tile_potential_inr, o.obl_sale_forecast_inr  FROM dashboard_view_tbl o 
where o.[status]='open' 
...
order by o.obl_sale_forecast_inr desc ";
					...
					while($ttf=odbc_fetch_array($tte)){
						...
						echo '<tr align="center">';
							...
							echo '<a href="#">'.trim($ttf['project_name']).'</a>';
							echo '</td>';
...
<?php
	if(trim($_SESSION['user_type'])=='management') {
$ttv="SELECT top 10 o.cka_name,o.project_name, o.state_name,o.current_stage, o.created_by, o.project_tile_potential_inr,o.obl_sale_forecast_inr  FROM dashboard_view_tbl o 
where o.[status]='lost' 
