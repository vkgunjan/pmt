...
$sql = "SELECT o.opportunity_id, o.lead_id, u.fullname, o.project_name, o.quotation_code, m.email, o.project_name  from opportunity o
...
$result = odbc_exec($conn,$sql);
        ...
        $opp_id = $f['opportunity_id'];
				...
				$u_mail = $f['email'];
				$quotation_code = $f['quotation_code'];
...
if(isset($_POST['approve'])){
	...
	if ($lead_no == $lead_id && $quotation_code == $code) {
		$query = "UPDATE opportunity set quotation_status = '2', quotation_code = '0', current_stage = '2', qt_approve_date = '$timestamp', qt_approval_remark = '$remarks' where lead_id = '$lead_id'";
		$query_result = odbc_exec($conn, $query);

    $fld_query = "UPDATE fld set status = '0' where opp_id = '$opp_id' ";
...
$result = odbc_exec($conn,$sql);
		...
		if($query_result){
                        $to = $ud_mail;
                        $subject = "PMT || Quotation Approval Request-[$lead]";
                        $body = "
                        <h4>Dear $name,</h4>
                        <br>
...
if(isset($_POST['reject'])){
	...
	if ($lead_no == $lead_id && $quotation_code == $code) {
		$query = "UPDATE opportunity set quotation_status = '0', quotation_code = '0', qt_reject_date = '$timestamp', qt_reject_remark = '$remarks' where lead_id = '$lead_id'";
		$query_result = odbc_exec($conn, $query);

    $fld_query = "UPDATE fld set status = '1' where opp_id = '$opp_id' ";
    $fld_result = odbc_exec($conn, $fld_query);
                  ...
                  <div class="portlet box">
                     ...
                     <div class="portlet-body form">
                     	<div class="well" style="margin-top: 50px;">
										<h4>Approval for Pricing on Lead <b>[<?php echo $lead_id ?>]</b></h4>
										This is an approval request for Lead generated by <b><?php echo $u_name ?></b> for <b>"<?php echo $p_name ?>"</b> . Kindly Approve/Reject pricing quotation with your relevent remarks.
									</div>
                        <!-- BEGIN FORM-->
                        ...
                        <form action="price-approve.php?ld=<?php echo $lead_id ?>&code=<?php echo $code ?>" class="form-horizontal" style="margin-top: 30px !important;" method="POST">
