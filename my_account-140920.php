...
<!-- Data Model End -->
 ...
 <!-- <input type="hidden" value="<?php echo $_GET['pid']?>" name="opportunity_id"  id="opportunity_id"/> -->
  ...
  <tr>
    ...
    <th><input type="number"  name="arch_email_id" id="arch_email_id" placeholder="Email ID"></th>    
...
<!-- </form> -->
   ...
   <script>
    ...
    <script>
      ...
      /* $('input:radio[name=engaged_modal]').select(function(){
        var new_modal = $('input:radio[name=engaged_modal]:checked').val();
        var eng_status_modal_u = $('#eng_status_modal').val();
        alert(new_modal);
        if(new_modal == "Yes" && eng_status_modal_u >1){
            alert("Wrong Engaged Type Selected");
            return false;
          }else{
            $("#eng_status_modal").empty();
            $("#sub_status_modal").empty();
                 $("#eng_status_modal").append("<option value='1'>Not Engaged</option>");
                 $("#sub_status_modal").append("<option value='1'>Not Engaged</option>");
          }
