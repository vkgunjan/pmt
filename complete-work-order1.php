	                         ...
	                         <tr>
                                ...
                                <td colspan="2">
                                          ...
                                          <select class="small m-wrap" tabindex="1" name="wo_c_month">
                                             <?php
											   ...
											   'August','September','October','November','December');
													 for($x=date('m');$x<sizeof($monthArray);$x++){
                                 ...
                                 <tr>
                                    ...
                                    <td width="20%">
                                            <select style="width:230px" id="states"  onChange="display(this.value)" >
                                            

                                             <?php
								$ssql="select top 10 spare_part_id,spare_part_name from spare_part_master order by spare_part_name ";	
