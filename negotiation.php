					...
					<div class="span12">
						...
						<div class="portlet box blue">
							<div class="portlet-title">
								<h4><i class="icon-edit"></i>List of All Lead at Pricing/Quotation Level</h4>
								<div class="tools">
							...
							<div class="portlet-body">
								<div class="clearfix">
                                    ...
                                    <?php /*?>	&nbsp;&nbsp;&nbsp;							
										<font color="#000000"><span class="label label-success">O</span> - Open</font><?php */?>
...
-->                                            <th>Sales Phase</th>
  ...
  ";
    ...
    if(trim($_SESSION['user_type'])=='management') {
		$sql.="  where d.current_stage='2' and d.status='open' order by date_added desc ";
	}else{
...
//vks start
					...
					$sql.=" where d.current_stage='6' 
						...
						$sql .=" )order by d.obl_sale_forecast_inr desc ";
					}else{
						$sql.=" where ( d.deal_type='CKA' 
						and d.current_stage='6' 
						and d.status='open' 
						) and ( ";
...
if ($quotation_status == 0) {	
							echo '<td>';
							echo '<a href="negotiation-submit.php?pid='.$f['opportunity_id'].'" title="Apply Discount"><i style="padding:0px 12px; font-size:19px;" class="icon-share"></i></a>';
							echo '</td>';
				}else{
							echo '<td>';
...
//											echo '<td>'.$uf['fullname'].' ('.$uf['employee_department'].')</td>';
										...
										if(trim($f['status'])=='open'){
											...
											echo '<td><a href="negotiation-submit.php?pid='.$f['opportunity_id'].'" title="Apply Discount">'.$cstage.'</td></a>';
										
							if ($quotation_status == 0) {	
							echo '<td>';
							/*echo '<a href="negotiation-submit.php?pid='.$f['opportunity_id'].'" class="btn mini blue">Apply Discount</a>';*/
							...
							echo '</td>';
				}elseif($quotation_status == 2){
							echo '<td>';
							echo '<a href="negotiation-submit.php?pid='.$f['opportunity_id'].'" class="btn mini blue">Approved</a>';
							/*echo '<a href="lead-history.php?pid='.$f['opportunity_id'].'" class="btn mini yellow no-print"><font color="#000">Detail&nbsp;</font></a>';*/
							echo '&nbsp;&nbsp;<a href="closure-won.php?pid='.$f['opportunity_id'].'" class="btn mini green"><i class="icon-edit"></i>Won</a>';
							echo '&nbsp;&nbsp;<a href="closure-lost.php?pid='.$f['opportunity_id'].'" class="btn mini red"><i class="icon-edit"></i>Lost</a>';
							echo '</td>';
				}elseif(($_SESSION['user_type'] == 'manager') && $quotation_status== 1){
							echo '<td>';
							echo '<a href="negotiation-submit.php?pid='.$f['opportunity_id'].'" class="btn mini red">Pending</a>';
							echo '&nbsp;&nbsp;<a href="http://pmt.orientapps.com/pmt/price-approve.php?ld='.$f['lead_id'].'&code='.$f['quotation_code'].'" target="_blank" class="btn mini black no-print"><font color="#fff">Approve</font></a>';
							/*echo '<a href="lead-history.php?pid='.$f['opportunity_id'].'" class="btn mini yellow no-print"><font color="#000">Detail&nbsp;</font></a>';*/
							echo '</td>';
				}else{
							echo '<td>';
